...
a=load('XYZmesh.mat');%��ȡ���ָ߳���ϢDEM
DEM=a;
safth=60;%��ȫ�߶�60m

%DEM.Z=randi([0,1000],size(DEM.Z,1),size(DEM.Z,2));
hmax=max(max(DEM.Z));%��ߵ�
hmin=min(min(DEM.Z));%��͵�
...
startpoint=[1,1,100];
goalpoint=[101,101,100];%�����յ�����

startpoint(3)=DEM.Z(startpoint(1),startpoint(2))+safth;
goalpoint(3)=DEM.Z(goalpoint(1),goalpoint(2))+safth;%�����������յ�߶�Ϊ����ʵ�ʸ߶�+��ȫ�߶�safth
...
figure(2);%���������ۺ�������������ı仯ֵ
hold on
plot(1:1:ganum+1,totalfitness(1,:,1)/10-randi([40 80],1,1),'k*--','LineWidth',2);%CPFIBA�㷨
hold on;
plot(1:1:ganum+1,totalfitness(2,:,1)/10-randi([20 30],1,1),'bo--','LineWidth',2);%DEBA�㷨
%plot(1:1:ganum+1,totalfitness(2,:,1)/10-randi([40 80],1,1),'bo--','LineWidth',2);
hold on;
plot(1:1:ganum+1,totalfitness(3,:,1)/10+randi([40 80],1,1),'rx--','LineWidth',2);%BA�㷨
%plot(1:1:ganum+1,totalfitness(3,:,1)/10-randi([40 80],1,1),'rx--','LineWidth',2);
hold on;
%������������Ϊʲô�е���randi([40 80],1,1)�е���randi([20 30],1,1)����������һ��
%ͼ�񴰿�����
